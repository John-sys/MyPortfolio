      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 text-black">
        ...
        <div className=" my-auto ">
          ...
          <p>
            ...
            nostrum eligendi ullam unde! Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Numquam excepturi tempora cupiditate enim corrupti
            pariatur voluptatum accusantium, error praesentium aliquam rem culpa
            vero, ex sint facilis eligendi aperiam ut magnam? Lorem ipsum dolor
            sit amet consectetur adipisicing elit. Officia a delectus corporis
            nulla, accusamus magnam, nobis, sequi placeat reiciendis fuga
            repellendus perferendis aliquid numquam magni veritatis vel. Quasi,
            deserunt adipisci!{" "}
          </p>
