...
const Hero = () => {
  return (
    <div className="text-white  ">
      <div className="max-w-[800px]  w-full md:h-screen mx-auto flex flex-col text-center justify-center  ">
        ...
        <button className=" bg-[#00df9a] w-[200px] rounded-md font-medium my-2 text-black hover:bg-gray mx-auto py-3 ">
          Get Started
        </button>
